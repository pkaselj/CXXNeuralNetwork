...
int main()
{
	Vector2D l1_w = ParseCsv2D("C:\\Users\\Admin-PC\\Desktop\\PP\\CXXNeuralNetwork\\Data\\l1_w.csv");
	Vector1D l1_b = ParseCsv1D("C:\\Users\\Admin-PC\\Desktop\\PP\\CXXNeuralNetwork\\Data\\l1_b.csv");
	/* LAYER DEFINITIONS */
